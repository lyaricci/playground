...
def get_player_choice():
    """
    Get the player input and prompt for a choice
    while it's not in the options list
    """
...
def play_round():
    ...
    print(f"You chose {player_selection} and the computer chose {computer_selection}")
